...
<body class="background" style="background-image: url('https://storage.googleapis.com/kdawpmedia/custom-app-dev1.jpg')" >
    <nav class="navbar navbar-expand-md navbar-dark" style="background-color: black">
        <div style="text-align:center;">
        <a href="https://" class="navbar-brand"> CEYLON LINUX</a>
        </div>
    </nav>
    <br>
    <div style="text-align:center;">
        ...
        <a href="/creditorBalance"><button  class="btn btn-primary">Creditor Balance</button></a> 
    </div>
